...
const HeroSection = () => {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Main Content */}
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="relative z-10 text-center max-w-6xl mx-auto section-padding px-4 sm:px-6">
        <motion.div variants={itemVariants} className="mb-4 sm:mb-6">
          <motion.p className="text-green-500 text-base sm:text-lg md:text-xl font-inter tracking-wider uppercase" initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5, duration: 0.8 }}>
            Hello, I'm
          </motion.p>
        </motion.div>

        <motion.div variants={nameVariants} className="mb-6 sm:mb-8">
          <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-fraunces font-bold leading-none">
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
          <MagneticButton 
            ...
            className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-transparent border-2 border-champagne text-champagne font-inter font-medium text-base sm:text-lg rounded-full overflow-hidden transition-all duration-300 hover:bg-champagne hover:text-charcoal w-full sm:w-auto" 
          ...
          <MagneticButton 
            ...
            className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-champagne text-charcoal font-inter font-medium text-base sm:text-lg rounded-full overflow-hidden transition-all duration-300 hover:bg-champagne-light w-full sm:w-auto" 
            whileHover={{ scale: 1.05 }} 
            whileTap={{ scale: 0.95 }}
          >
        ...
        <motion.div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 hidden sm:block" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 2, duration: 0.8 }}>
